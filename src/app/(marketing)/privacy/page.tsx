  ...
  return (
    ...
    >
      <LegalSection title="1. 처리 목적">
        ...
        <LegalList
          items={[
            ...
            "기사 폰의 위치 정보를 기반으로 실시간 위치를 학부모에게 전송",
        ...
        <LegalList
          items={[
            ...
            <>
              ...
              ·전원하차), 탑승·하차 기록(시각·위치), 운행 중 위치 신호
            </>,
            <>
              <strong>자동 수집</strong>: 접속 기기 정보(브라우저 종류·버전),
              접속 IP, 푸시 구독 주소, 서비스 이용 기록(오류 로그)
            </>,
          ]}
        />
      </LegalSection>
      ...
      <LegalSection title="3. 위치정보 수집·이용에 관한 별도 고지">
        <p>
          기사 폰의 위치 정보는 다음 원칙에 따라 처리됩니다(위치정보의 보호
          및 이용 등에 관한 법률 준수).
        </p>
        <LegalList
          items={[
            "수집은 운행 시작~종료 시점 사이에만 이루어집니다.",
            "운행 종료 즉시 기사 폰의 위치 송신이 중단됩니다.",
            "실시간 위치 전송은 5초 간격으로 학부모에게만 전달되며 영구 저장되지 않습니다.",
            "영구 저장은 30초 간격 또는 정류장 통과 시점에 한해 위치 기록 데이터베이스에 저장됩니다.",
            "학부모는 본인 자녀가 탑승한 운행의 위치만 조회할 수 있습니다.",
          ]}
        />
      </LegalSection>
      ...
      <LegalSection title="4. 개인정보의 보유 및 이용 기간">
        <LegalList
          items={[
            ...
            "운행 데이터(안전점검·탑승·하차·위치 신호): 분기 종료 후 최소 3년 (도로교통법 §53⑦ 안전운행기록 의무 대응)",
            "결제·세금계산서 정보: 전자상거래법에 따라 5년",
            "푸시 구독 정보: 구독 해제 또는 만료 시 즉시 삭제",
          ]}
        />
      </LegalSection>
      ...
      <LegalSection title="6. 처리 위탁">
        ...
        <LegalList
          items={[
            "Supabase Inc. — 데이터베이스·인증·실시간 위치 전송 (서울 데이터센터)",
            "Vercel Inc. — 웹 호스팅·콘텐츠 전송 네트워크",
            "Kakao Corp. — 카카오맵 (정류장·위치 시각화)",
            "푸시 알림 서비스 제공자(Mozilla·Google·Apple) — 학부모·기사·학원장에게 푸시 전달",
          ]}
        />
