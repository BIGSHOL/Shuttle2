...
//
// W23: monorepo 전환 — 기사용 RN 앱과 코드 공유. (Next.js·RN·Browser·Node.js
// 모두 호환되는 ES 모듈만 두는 것이 원칙.)
...
//
// crypto.getRandomValues는 Node.js 19+, 모든 모던 브라우저, 그리고 RN
// (react-native-get-random-values polyfill 적용 시) 모두 사용 가능.
